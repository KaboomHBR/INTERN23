...
urlpatterns = [
    ...
    path('password-reset/', auth_views.PasswordResetView.as_view(
        template_name='ups/password_reset.html'), name='password_reset'),
    path('password-reset/done/', auth_views.PasswordResetDoneView.as_view(
        template_name='ups/password_reset_done.html'), name='password_reset_done'),
    path('password-reset-confirm/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(
        template_name='ups/password_reset_confirm.html'), name='password_reset_confirm'),
    path('password-reset-complete/', auth_views.PasswordResetCompleteView.as_view(
        template_name='ups/password_reset_complete.html'), name='password_reset_complete'),
    ...
    path('package/<int:pk>/update', ups_views.PackageUpdateView.as_view(
        template_name='ups/package_form.html'), name='package-update'),
    path('package/<int:pk>/eva_update', ups_views.PackageEvaUpdateView.as_view(
        template_name='ups/package_form.html'), name='package-evaupdate')
]
